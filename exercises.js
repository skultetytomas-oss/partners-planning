...
// Generated by Admin Panel · v2.0.4 · 2026-08-02
...
window.EXERCISES_CONFIG = {
  ...
  "exercises": {
    ...
    "clients": [
      {
        "id": "c01",
        "text_en": "SERVICE: Clients without Partners Investments? Write names.",
        "text_sk": "SERVIS: Klienti bez investícií partnerov? Napíšte mená.",
        "text_bg": "SERVICE Клиенти без Партнърс инвестменс? Напишете имена.",
        "inputs": 5,
        "placeholder_en": "Name",
        "placeholder_sk": "Meno",
        "placeholder_bg": "Име",
        "text": "SERVICE: Clients without Partners Investments? Write names.",
        "placeholder": "Name"
      },
      {
        "id": "c02",
      ...
      {
        "id": "c12",
        "text_en": "SERVICE: Clients for Credit Guard and ML Care product? Write their names.",
        "text_sk": "SLUŽBA: Klienti pre produkt Credit Guard a ML Care? Napíšte ich mená.",
        "text_bg": "SERVICE: Клиенти за продукт Кредит гард и ML Грижа? Напишете имената им.",
        "inputs": 8,
        "placeholder_en": "Name",
        "placeholder_sk": "Meno",
        "placeholder_bg": "Име",
        "text": "SERVICE: Clients for Credit Guard and ML Care product? Write their names.",
        "placeholder": "Name"
      },
      {
        "id": "c13",
      ...
      {
        "id": "c20",
        "text_en": "SERVICE: Clients with PI but without Real Estate strategy.",
        "text_sk": "SLUŽBA: Klienti s PI, ale bez realitnej stratégie.",
        "text_bg": "SERVICE: Клиенти с ПИ, но без стратегия за недвижими имоти.",
        "inputs": 8,
        "placeholder_en": "Name",
        "placeholder_sk": "Meno",
        "placeholder_bg": "Име",
        "text": "SERVICE: Clients with PI but without Real Estate strategy.",
        "placeholder": "Name"
      },
      {
        "id": "c21",
      ...
      {
        "id": "c23",
        "text_en": "How will you get to know 10 new full-time employed people this month? Write specific strategies and names if you already have people in mind.",
        "text_sk": "Ako spoznáte tento mesiac 10 nových zamestnancov na plný úväzok? Napíšte konkrétne stratégie a mená, ak už máte na mysli ľudí.",
        "text_bg": "Как ще опознаете 10 нови служители на пълно работно време този месец? Напишете конкретни стратегии и имена, ако вече имате предвид хора.",
        "inputs": 5,
        "placeholder_en": "Strategy / name",
        "placeholder_sk": "Stratégia / meno",
        "placeholder_bg": "Стратегия / Име",
        "text": "How will you get to know 10 new full-time employed people this month? Write specific strategies and names if you already have people in mind.",
        "placeholder": "Strategy / name"
      },
      {
        "id": "c24",
        "text_en": "Choose 5 people who work in corporation from your database.",
        "text_sk": "Vyberte si z vašej databázy 5 ľudí, ktorí pracujú v spoločnosti.",
        "text_bg": "Изберете 5 души, които работят в корпорацията от вашата база данни.",
        "text": "Choose 5 people who work in corporation from your database.",
        "inputs": 5,
        "placeholder_en": "Choose 5 people who work in corporation from your database.",
        "placeholder_sk": "Vyberte si z vašej databázy 5 ľudí, ktorí pracujú v spoločnosti.",
        "placeholder_bg": "Изберете 5 души, които работят в корпорацията от вашата база данни.",
        "placeholder": "Choose 5 people who work in corporation from your database."
      }
    ]
  },
  "monthly_schedule": {
